...
# character to use for marking the Sierpinski Triangle
mark = "#"
...
# title for output  
title = f"""
            Pascal's triangle showing the last digit of each number, this version does not use ANSI codes
            Repeating the triangle replacing uneven last digits with {mark} shows a Sierpinski triangle
"""  
print(title)
...
for row_number, row_as_list in enumerate(pascal_triangle):
    ...
    print("  " + " " * (31 - row_number) + row_as_str +" " * (64 - row_number * 2) + row_of_marks)
